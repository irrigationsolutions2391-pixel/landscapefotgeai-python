...
from ._exceptions import APIStatusError, LandscapefotgeaiError
...
class Landscapefotgeai(SyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Landscapefotgeai client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("LANDSCAPEFOTGEAI_BASE_URL")
        if base_url is None:
    ...
    @cached_property
    def with_raw_response(self) -> LandscapefotgeaiWithRawResponse:
        return LandscapefotgeaiWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> LandscapefotgeaiWithStreamedResponse:
        return LandscapefotgeaiWithStreamedResponse(self)
...
class AsyncLandscapefotgeai(AsyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncLandscapefotgeai client instance.
    ...
    @cached_property
    def with_raw_response(self) -> AsyncLandscapefotgeaiWithRawResponse:
        return AsyncLandscapefotgeaiWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncLandscapefotgeaiWithStreamedResponse:
        return AsyncLandscapefotgeaiWithStreamedResponse(self)
...
class LandscapefotgeaiWithRawResponse:
    _client: Landscapefotgeai

    def __init__(self, client: Landscapefotgeai) -> None:
        self._client = client
...
class AsyncLandscapefotgeaiWithRawResponse:
    _client: AsyncLandscapefotgeai

    def __init__(self, client: AsyncLandscapefotgeai) -> None:
        self._client = client
...
class LandscapefotgeaiWithStreamedResponse:
    _client: Landscapefotgeai
...
class AsyncLandscapefotgeaiWithStreamedResponse:
    _client: AsyncLandscapefotgeai
...
AsyncClient = AsyncLandscapefotgeai
